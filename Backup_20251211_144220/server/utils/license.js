...
// For this standalone version, we'll use a hardcoded secret but complex enough
...
class LicenseManager {
  ...
  static async checkActivationStatus() {
    try {
      ...
      // Re-validate the stored key to ensure it hasn't been tampered with
      // or if system clock has moved past expiry
      const validation = await this.validateLicenseKey(settings.licenseKey);
