  ...
  try {
    ...
    res.json({
      ...
      student: {
        ...
        name: examCard.student.user ? [examCard.student.user.firstName, examCard.student.user.middleName || examCard.student.middleName, examCard.student.user.lastName].filter(Boolean).join(' ') : (examCard.student.name || examCard.student.admissionNumber || 'Student'),
      ...
      try {
        ...
        if (existing) {
          results.alreadyExists.push({
            studentId: record.studentId,
            name: record.student.user ? [record.student.user.firstName, record.student.user.middleName || record.student.middleName, record.student.user.lastName].filter(Boolean).join(' ') : (record.student.name || record.student.admissionNumber || 'Student'),
