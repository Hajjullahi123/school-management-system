  ...
  return (
    <Document>
      {reports.map((data, index) => {
        ...
        const isEarlyYears = layoutRawDB.startsWith('early_years') || (!isExplicitNonEarlyYears && /early|nursery|kg|kindergarten|reception|playgroup|toddler|creche|pre-k|ركن|الركن|روضة|الروضة|تمهيدي|حضانة/i.test(student.class || data.className || ''));
