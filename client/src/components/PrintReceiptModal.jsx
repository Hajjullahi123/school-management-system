...
export default function PrintReceiptModal({ student, isOpen, onClose, currentTerm, currentSession, allTerms, allSessions, currentPayment }) {
  ...
  const generateSinglePaymentReceipt = (payment) => {
    ...
    return `
      ...
      <head>
        <meta charset="UTF-8">
        <title>Receipt - ${student.admissionNumber}</title>
        ...
        <div class="receipt-card">
          ...
          <div class="receipt-header">
            ...
            <div style="text-align: right">
              ...
              <p style="font-size: 9px; margin-top: 4px; opacity: 0.9;">#${payment.id}</p>
            </div>
          </div>
      ...
      <body>
        <div class="ledger-card" style="position: relative;">
          ...
          <div class="header">
            ...
            <div style="text-align: right">
              <div style="font-weight: 600; font-size: 16px;">${student.user?.firstName || 'Unknown'} ${student.user?.lastName || ''} ${student.middleName || ''}</div>
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          {student && (
            <div className="mt-4 text-sm text-gray-600">
              <p><strong>Student:</strong> {student.user?.firstName || 'Unknown'} {student.user?.lastName || ''} {student.middleName || ''}</p>
