...
const Layout = () => {
  ...
  // Add Admin/Principal/Staff HR access if they don't have it via other groups
  const staffRoles = ['admin', 'principal', 'hr_admin', 'staff', 'examination_officer', 'attendance_admin', 'registrar', 'librarian'];
