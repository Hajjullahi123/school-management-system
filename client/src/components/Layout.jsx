...
const Layout = () => {
  ...
  if (user?.role === 'superadmin') {
    menuItems.push(
      ...
      {
        path: '/dashboard/superadmin#schools',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        path: '/dashboard/superadmin#platform',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        path: '/dashboard/superadmin#audits',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        path: '/dashboard/superadmin#academic',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      },
      {
        ...
        items: [
          ...
          {
            path: '/dashboard/global-news',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
              </svg>
            ),
            label: 'Global News & Events'
          },
          {
            path: '/dashboard/global-gallery',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (user?.departmentAsHead) {
    menuItems.push({
      ...
      items: [
        {
          path: '/dashboard/department-monitoring',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  ...
  if (user?.role === 'admin' || user?.role === 'sub_admin' || user?.role === 'principal' || user?.role === 'examination_officer' || user?.role === 'attendance_admin') {
        ...
        items: [
          {
            ...
            label: 'Overview (Sessions & Terms)'
          },
          {
            path: '/dashboard/school-setup',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {
            path: '/dashboard/exam-config?tab=early-years',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
              </svg>
            ),
            label: 'Early Years Domains'
          },
          {
          ...
          {
            path: '/dashboard/attendance-tracker',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          if (item.path === '/dashboard/school-setup' && !['admin', 'principal'].includes(user?.role)) {
            return false;
          }
    ...
    } // end: not examination_officer (Academic Setup)

    // Assessment & Results Group
    if (['admin', 'sub_admin', 'principal', 'examination_officer'].includes(user?.role)) {
      menuItems.push({
        type: 'group',
        ...
        items: [
          ...
          {
            path: '/dashboard/cbt-bank',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002-2V8m-9 4h4" />
              </svg>
            ),
            label: 'Question Bank'
          },
          {
            path: '/dashboard/term-report',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
          ...
          {
            path: '/dashboard/progressive-report',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {
            path: '/dashboard/cumulative-report',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    if (user?.role !== 'examination_officer' && user?.role !== 'attendance_admin') {
      menuItems.push({
        ...
        items: [
          ...
          {
            path: '/dashboard/users?role=staff',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {
            path: '/dashboard/credential-repository',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
              </svg>
            ),
            label: 'Credential Repository'
          },
          {
            path: '/dashboard/directory-export',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4-4m0 0L8 8m4-4v12" />
              </svg>
            ),
            label: 'Directory Export'
          },
          {
      ...
      // Admissions Management (Moved out of User Management)
      menuItems.push({
  ...
  // --- STAFF SELF-SERVICE (HR HUB) ---
  const hrHubItem = {
    path: '/dashboard/hr-center',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (user?.role === 'teacher' || user?.teacher || user?.role === 'principal' || isFormMaster) {
    ...
    teacherItems.push({
      ...
      items: [
        ...
        {
          path: '/dashboard/academic-workspace',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </svg>
        ...
        {
          path: '/dashboard/exam-repository',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          ),
          label: 'Exam Repository'
        }
      ]
    });
    ...
    // Only show Quran Tracker for teachers who have Quran access
    if (hasQuranAccess) {
      teacherItems.push({
  ...
  if (user?.role === 'accountant') {
    ...
    menuItems.push({
      path: '/dashboard/misc-fee-payments',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2z" />
        </svg>
      ),
      label: 'Misc Fee Payments'
    });
    menuItems.push(hrHubItem);
  }

  // Add Staff HR access if they don't have it via other groups
  const staffRoles = ['hr_admin', 'staff', 'examination_officer', 'attendance_admin', 'registrar', 'librarian'];
  if (staffRoles.includes(user?.role) && user?.role !== 'teacher' && user?.role !== 'accountant') {
     // Check if hrHubItem is already added
     const hasHrHub = menuItems.some(item => item.path === '/dashboard/hr-center' || (item.items && item.items.some(sub => sub.path === '/dashboard/hr-center')));
     if (!hasHrHub) {
        menuItems.push(hrHubItem);
     }
  }
  ...
  if (user?.role === 'parent' || user?.parent) {
    const parentItems = [
      {
        path: '/dashboard/parent-view?view=parent',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
      ...
      {
        path: '/dashboard/parent/attendance?view=parent',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
          </svg>
      ...
      {
        path: '/dashboard/term-report?view=parent',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
          </svg>
      ...
      {
        path: '/dashboard/parent/messages?view=parent',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
          </svg>
  ...
  if (user?.role === 'admin' || user?.role === 'sub_admin' || user?.role === 'principal' || user?.role === 'examination_officer' || user?.role === 'attendance_admin') {
    ...
    if (true) { // Allow all admin-level roles to see items in this group
      menuItems.push({
        ...
        items: [
          ...
          {
            path: '/dashboard/curriculum-management',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
          ...
          {
            path: '/dashboard/document-branding',
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    // Leadership & Department Oversight (Moved after Academic Management)
    ...
    // --- HUMAN RESOURCES MANAGEMENT (ADMIN/PRINCIPAL/HR_ADMIN) ---
    // Rearranged: Now appears after Timetable & Scheduling
    if (user?.role === 'admin' || user?.role === 'principal' || user?.role === 'hr_admin') {
      menuItems.push({
        type: 'group',
    ...
    // HR Management (Only for authorized roles)
    if (user?.role === 'admin' || user?.role === 'principal' || user?.role === 'superadmin' || user?.role === 'hr_admin') {
      menuItems.push({
        type: 'group',
        label: 'HR & Personnel',
        icon: (
  ...
  // Final Reports Group for Students and Parents (who don't have bulk download access)
  ...
  // Quran Tracker - Shared for Principal and authorized Teachers (Hidden for Admin)
  if (hasQuranAccess && (['principal', 'teacher'].includes(user?.role))) {
    menuItems.push({
      path: '/dashboard/quran-tracker',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden print:h-auto print:overflow-visible print:block">
          ...
          {menuItems.map((item, index) => (
            item.type === 'group' ? (
              ...
              <Link
                ...
                to={item.path}
                onClick={() => setSidebarOpen(false)}
                className={`flex items-center gap-3 px-3 py-3 text-base rounded-xl transition-all duration-200 ${location.pathname + (location.hash || "") === item.path
      ...
      <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar pb-[safe-area-inset-bottom] print:overflow-visible print:h-auto print:block">
        ...
        {isImpersonating && (
          <div className="impersonation-banner bg-red-600 text-white px-4 py-3 flex flex-col sm:flex-row sm:items-center justify-between text-sm shadow-lg z-[100] gap-3 print:hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                <div className="text-right hidden md:block">
                  <p className="text-xs sm:text-sm font-semibold text-gray-700">Academic Context</p>
                  <p className="text-[10px] sm:text-xs text-gray-500">
                    {schoolSettings?.currentSession?.name || `${new Date().getFullYear()}/${new Date().getFullYear() + 1}`}
                    {schoolSettings?.currentTerm && <span className="mx-1">•</span>}
                    {schoolSettings?.currentTerm?.name}
                  </p>
                </div>
        ...
        {/* Page Content */}
        <main className="flex-1 bg-gray-50 p-2 sm:p-6 lg:p-8 print:p-0 print:bg-white print:overflow-visible pb-20 lg:pb-8">
          <Outlet />
        </main>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-gray-200 px-2 py-2 flex items-center justify-around z-50 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] pb-[safe-area-inset-bottom] print:hidden">
          {(() => {
            ...
            if (user?.role === 'parent' || user?.parent) {
              ...
              if (isFormMaster) {
                bottomItems.push({
                  path: '/dashboard/teacher/messages', label: 'Messaging', icon: (
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                  ), badge: unreadCount
