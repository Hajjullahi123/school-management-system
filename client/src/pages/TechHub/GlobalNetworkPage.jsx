...
const GlobalNetworkPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pb-32">
      {/* Hero */}
      <section className="tech-hero py-24 px-6 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto text-center relative z-10">
          <h1 className="tech-fluid-h1 font-bold mb-6 animate-fade-up">40+ edge locations.<br/><span className="text-cyan-400">One unified learning graph.</span></h1>
          <p className="tech-fluid-base text-gray-400 max-w-2xl mx-auto mb-12 animate-fade-up delay-100">Distributed, low-latency, and internationally compliant infrastructure built specifically for the demands of real-time education.</p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 border-y border-gray-800 bg-[#0A0A0A]">
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4 animate-fade-up delay-200">
            <h2 className="tech-fluid-h2 flex items-center gap-2"><Globe className="text-cyan-400"/> Live Network Telemetry</h2>
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          {searchResult && (
            <div className="grid md:grid-cols-3 gap-4 text-left animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="tech-glass-dark rounded-xl p-6">
      ...
      <section className="py-16 px-6">
        <div className="max-w-[1400px] mx-auto animate-fade-up">
          <h2 className="tech-fluid-h2 mb-8">Regional Capabilities</h2>
          <div className="tech-glass-dark rounded-2xl overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm region-table">
