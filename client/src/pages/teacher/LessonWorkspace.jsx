...
const LessonWorkspace = () => {
 ...
 <button onClick={() => editItem(item)} className="text-indigo-600 hover:text-indigo-800 p-1 transition-opacity"><FiPlus /></button>
 <button className="text-red-500 hover:text-red-700 p-1 transition-opacity"><FiTrash2 /></button>
 </div>
 </div>
