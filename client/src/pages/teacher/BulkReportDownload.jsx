                                ...
                                <div className="space-y-6">
                                  ...
                                  <div className="bg-white border-4 border-black p-4 space-y-2 print:p-3 print:space-y-1">
                                    <div className="text-center space-y-1">
                                      ...
                                      <h2 className="text-base font-black uppercase tracking-wider border-y-2 border-black py-1 mt-1 text-black">
                                    ...
                                    {allDomains.map((domain, dIdx) => (
                                      <div key={dIdx} className="border-2 border-black overflow-hidden">
                                        <div className="bg-gray-200 px-2 py-0.5 font-black text-[10px] uppercase border-b-2 border-black text-black">
                                          {domain.name}
                                        </div>
