  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg p-6 shadow-lg">
        <h1 className="text-2xl font-bold mb-2">Qur'an Progress Monitor</h1>
        <p className="text-purple-100">Track your child's memorization journey</p>
      </div>
          ...
          >
            {children.map(child => (
              <option key={child.id} value={child.id}>
                {child.user.firstName} {child.user.lastName} - {child.admissionNumber}
              </option>
            ))}
          </select>
        </div>
      ...
      {targets.length > 0 && (
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b">
            ...
            <p className="text-sm text-gray-600">Current memorization goals for the class</p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b">
          <h2 className="text-lg font-bold text-gray-900">Progress History</h2>
          <p className="text-sm text-gray-600">Detailed record of memorization sessions</p>
        </div>
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-400 mt-1">The teacher will add sessions soon</p>
            </div>
          ) : (
