            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className="appearance-none block w-full px-3 pr-10 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
