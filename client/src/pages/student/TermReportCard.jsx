          ...
          <div ref={printRef} className="space-y-20 print:space-y-0">
            ...
            return (
              <div key={idx} className="mb-20 last:mb-0 print:mb-0">
                ...
                <div className="relative z-10 space-y-2.5 print:space-y-2 flex flex-col justify-between min-h-[280mm] print:min-h-[280mm] h-full">
                  {layout === 'early_years' ? (() => {
                              ...
                              return (
                                <div key={dIdx} className="border-2 border-black overflow-hidden shadow-xs">
                                  <div className={`px-3 py-1 font-black text-xs sm:text-[12.5px] uppercase border-b-2 border-black flex justify-between items-center ${domainHeaderBg}`}>
                                    <span className="pr-2 break-words flex-1 min-w-0">{domain.name}</span>
                                    <span className="text-[10px] font-bold opacity-90 whitespace-nowrap shrink-0 ml-2">Domain {dIdx + 1}</span>
                                  </div>
                        ...
                        {extraDomains.map((domain, dIdx) => {
                          ...
                          return (
                            <div key={dIdx} className="border-2 border-black overflow-hidden shadow-xs">
                              <div className={`px-3 py-1 font-black text-xs uppercase border-b-2 border-black flex justify-between items-center ${domainHeaderBg}`}>
                                <span className="pr-2 break-words flex-1 min-w-0">{domain.name}</span>
                                <span className="text-[9px] font-bold opacity-80 whitespace-nowrap shrink-0 ml-2">Domain {dIdx + 3}</span>
                              </div>
                              <table className="w-full border-collapse text-xs">
                                <thead>
                                  <tr className="bg-gray-100 border-b border-black text-[11px] font-black uppercase text-black">
