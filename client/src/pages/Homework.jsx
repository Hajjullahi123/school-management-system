...
"{hw.submission.feedback}"
 ...
 className="w-full mt-6 py-3 bg-white text-primary font-black rounded-2xl shadow-xl transition-all border-none"
 >
 Resubmit
 </button>
 </div>
 ...
 className="w-full py-2 text-red-500 font-bold group-hover:text-white transition-all"
 >
 Kill Task
 </button>
 ) : null}
 ...
 <div className="bg-white rounded-[50px] shadow-2xl p-10 w-full max-w-2xl border border-white/20 animate-in zoom-in-95 duration-300 relative max-h-[90vh] overflow-y-auto custom-scrollbar">
 ...
 <div className="bg-white rounded-[40px] shadow-2xl p-8 w-full max-w-md border border-white/20 max-h-[90vh] overflow-y-auto custom-scrollbar">
 ...
 <div className="bg-white rounded-[40px] shadow-2xl p-10 w-full max-w-md border border-white/20 relative max-h-[90vh] overflow-y-auto custom-scrollbar">
