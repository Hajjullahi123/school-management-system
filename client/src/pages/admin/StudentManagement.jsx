      ...
      <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-6 mb-2 w-full">
        <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
          ...
          <div className="space-y-2 flex-1 text-center sm:text-left">
            ...
            <p className="mt-4 text-[10px] font-black uppercase tracking-widest text-red-600 flex items-center gap-2">
              <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
              Note: Classes must be created before students can be added 
            </p>
          </div>
        </div>
      </div>
