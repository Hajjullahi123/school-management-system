...
const StudentManagement = () => {
  ...
  const downloadCredentials = () => {
    ...
    try {
      ...
      doc.roundedRect(20, 20, 170, 100, 3, 3, 'F');
      doc.setDrawColor(209, 213, 219); // gray-300
      doc.roundedRect(20, 20, 170, 100, 3, 3, 'S');

      // Title
      doc.setFontSize(22);
      doc.setTextColor(17, 24, 39); // gray-900
      doc.text('Registration Successful!', 105, 35, { align: 'center' });

      // School Name if available
      if (schoolSettings?.schoolName) {
        doc.setFontSize(14);
        doc.setTextColor(75, 85, 99); // gray-600
        doc.text(schoolSettings.schoolName, 105, 45, { align: 'center' });
      }
      ...
      doc.text('Generated by School Management System', 105, 110, { align: 'center' });
