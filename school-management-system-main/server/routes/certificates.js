...
router.get('/verify/:certificateNumber', async (req, res) => {
  try {
    ...
    res.json({
      verified: true,
      studentName: certificate.student.user ? (certificate.student.middleName ? `${certificate.student.user.firstName} ${certificate.student.user.lastName} ${certificate.student.middleName}` : `${certificate.student.user.firstName} ${certificate.student.user.lastName}`) : (certificate.student.name || certificate.student.admissionNumber || 'Student'),
