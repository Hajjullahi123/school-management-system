...
const GalleryManagement = () => {
  ...
  // Helper to compress image on client-side before uploading
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          canvas.toBlob((blob) => {
            ...
            // Convert blob to File object to match the expected input
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Compress the image before uploading to avoid 413 Payload Too Large
    ...
    <div className="p-6">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar">
