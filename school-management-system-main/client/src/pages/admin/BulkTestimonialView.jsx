    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div ref={componentRef} className="print-container flex flex-col items-center gap-0 overflow-x-auto md:overflow-visible pb-10">
        {testimonials.map((testimonial) => {
          ...
          return (
            <div key={testimonial.id} className="testimonial-page bg-white relative overflow-hidden mx-auto my-4 shadow-xl md:shadow-none emerald-print-A4" style={{ width: '210mm', minWidth: '210mm', height: '297mm', padding: '15mm', fontFamily: testimFont }}>
              {/* Border */}
